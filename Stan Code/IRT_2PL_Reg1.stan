...
// 2-Parameter Logistic IRT model fit on only self-reported patient data
// with a single continuous covariate
...
data {
  ...
  vector[N] z;                    // subject-level covariate for patients
